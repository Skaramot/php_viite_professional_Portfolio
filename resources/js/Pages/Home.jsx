        ...
        <PortfolioShell title="Home | Karabo Motlaleselelo">
            <section className="relative flex min-h-[70vh] flex-col justify-center gap-10 pb-6 pt-10 lg:min-h-[78vh]">
                ...
                <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
                    ...
                    <div className="animate-float-in space-y-4 rounded-3xl border border-white/20 bg-white/10 p-6 shadow-[0_24px_60px_-32px_rgba(20,10,5,0.55)] backdrop-blur lg:ml-auto lg:max-w-md lg:translate-x-6">
                        <p className="text-xs uppercase text-amber-200/80">Profile</p>
