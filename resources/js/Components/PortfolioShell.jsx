        ...
        <>
            ...
            <div className="relative min-h-screen overflow-hidden text-slate-900 dark:text-slate-100">
                ...
                <header className="mx-auto flex max-w-6xl items-center justify-between px-6 pt-10">
                    <Link
                        href={route('home')}
                        className="rounded-full border border-white/20 bg-white/75 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-amber-800 shadow-sm backdrop-blur transition hover:shadow-md dark:border-white/10 dark:bg-slate-900/50 dark:text-amber-200"
                    >
                        Portfolio
                    </Link>
